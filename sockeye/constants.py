...
SENTENCE_SEPARATOR_SYMBOL = "<SEP>"

TOKEN_SEPARATOR = " "
VOCAB_SYMBOLS = [PAD_SYMBOL, UNK_SYMBOL, BOS_SYMBOL, EOS_SYMBOL, SENTENCE_SEPARATOR_SYMBOL]
...
MODEL_TYPE_CTX_DEC = "ctx_dec"
MODEL_TYPE_AVG_EMB_TOK = "avg_emb_tok"
MODEL_TYPE_AVG_EMB_ADD = "avg_emb_add"
MODEL_TYPE_MAX_EMB_TOK = "max_emb_tok"
MODEL_TYPE_MAX_EMB_ADD = "max_emb_add"
MODEL_TYPE_AVG_DOC_ATTN = "avg_emb_doc_attn"
MODEL_TYPE_AVG_MAX_EMB_ADD = "avg_max_emb_add"
MODEL_TYPES = [MODEL_TYPE_CTX_DEC, MODEL_TYPE_AVG_EMB_TOK, MODEL_TYPE_AVG_EMB_ADD, MODEL_TYPE_MAX_EMB_TOK, MODEL_TYPE_MAX_EMB_ADD, MODEL_TYPE_AVG_DOC_ATTN, MODEL_TYPE_AVG_MAX_EMB_ADD]
...
AVG_ACTIVATION_TYPES = [GELU, RELU, SWISH1, SIGMOID]
...
SHARD_CTX_SOURCE = SHARD_NAME + ".ctx_source"
