...
def create_data_iters_and_vocabs(args: argparse.Namespace,
    ...
    if args.prepared_data is not None:
        ...
        train_iter, validation_iter, data_config, source_vocabs, target_vocab = data_io.get_prepared_data_iters(
            ...
            is_model_average=utils.is_model_average(args.model_type))
        ...
        is_model_average = args.model_type == C.MODEL_TYPE_MAX_EMB_TOK or args.model_type == C.MODEL_TYPE_AVG_EMB_TOK or args.model_type == C.MODEL_TYPE_MAX_EMB_ADD or args.model_type == C.MODEL_TYPE_AVG_EMB_ADD or args.model_type == C.MODEL_TYPE_SUM_EMB_ADD or args.model_type == C.MODEL_TYPE_AVG_DOC_ATTN or args.model_type == C.MODEL_TYPE_AVG_MAX_EMB_ADD
        ...
        train_iter, validation_iter, config_data, data_info = data_io.get_training_data_iters(
            ...
            is_ctx_trg=args.is_ctx_trg,
            num_ctx_sentences=args.num_ctx_sentences,
...
def create_encoder_config(args: argparse.Namespace,
    ...
    if args.decoder_only:
        ...
        config_encoder = transformer.TransformerConfig(
            ...
            avg_emb_before=args.avg_emb_before,
            use_doc_pool=args.use_doc_pool,
            use_conv=args.use_conv,
            doc_pool_window=args.doc_pool_window,
            doc_pool_stride=args.doc_pool_stride,
            use_avg_pool=args.use_avg_pool,
            avg_act_type=args.avg_act_type,
            avg_dropout=args.avg_dropout,
...
def create_model_config(args: argparse.Namespace,
    ...
    model_config = model.ModelConfig(config_data=config_data,
                                     ...
                                     num_pointers=num_pointers,
                                     tie_ctx_emb_weights=args.tie_ctx_emb)
    return model_config
...
def train(args: argparse.Namespace, custom_metrics_logger: Optional[Callable] = None) -> training.TrainState:
    ...
    max_seq_len_ctx_source = max_seq_len_ctx_source + C.SPACE_FOR_XOS
